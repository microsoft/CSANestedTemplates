...
"@
        ...
        Script 'InstallNamedInstance-INST2016'{
            ...
            SetScript = {
                ...
                s:\setup /ACTION='Install' /SQLBACKUPDIR='H:\Backups' /AGTSVCACCOUNT=$AgtUserName /SQLUSERDBDIR='H:\SQLDATA' /SQLSVCPASSWORD=$SQLPassword /AGTSVCSTARTUPTYPE='Automatic' /IACCEPTSQLSERVERLICENSETERMS='True' /SQLTEMPDBLOGDIR='L:\SQLLOG' /INSTALLSHAREDWOWDIR='F:\Program Files (x86)\Microsoft SQL Server' /AGTSVCPASSWORD=$AgtPassword /QUIET='True' /INSTANCENAME='CLUSTER1' /INSTANCEDIR='F:\Program Files\Microsoft SQL Server' /SQLUSERDBLOGDIR='L:\SQLLOG' /SQLSYSADMINACCOUNTS=$SQLUsername '' /SQLTEMPDBDIR='T:\SQLTMP' /SQLCOLLATION='SQL_Latin1_General_CP1_CI_AS' /SQLSVCACCOUNT=$SQLUsername /FEATURES=SQLENGINE,REPLICATION,FULLTEXT,CONN,BC,SDK /INSTALLSQLDATADIR='H:\' /INSTALLSHAREDDIR='C:\Program Files\Microsoft SQL Server' /UPDATEENABLED='False' /BROWSERSVCSTARTUPTYPE='Automatic'
